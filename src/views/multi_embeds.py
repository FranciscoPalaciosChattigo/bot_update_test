...
class MultiEmbeds:
    ...
    @staticmethod
    def embed_confirm_auto(interaction, env, perfil, mark, jira):
        # Crea un embed
        embed = discord.Embed(
            title=f"Hola {interaction.user.name}! 🎉",
            description="He recibido tu solicitud con los siguientes detalles:",
    ...
    @staticmethod
    async def successful_emoji_reaction_answer(repo_environ, user_name):
        answer = discord.Embed(title=f"Hola {user_name}!, recibí tu reacción.",
    ...
    @staticmethod
    async def successful_canceled_run_petition_answer( repo_environ, html_url):
    ...
    @staticmethod
    async def failed_canceled_run_petition_answer( repo_environ, html_url):
